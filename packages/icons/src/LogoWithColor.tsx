...
const SvgLogoWithColor = React.forwardRef<
  SVGSVGElement,
...
>(({ size = 24, ...props }, ref) => (
  <svg
    ...
    {...props}
  >
    <g fill="#018381" clipPath="url(#logo-with-color_svg__a)">
    ...
    <defs>
      <clipPath id="logo-with-color_svg__a">
        <path fill="#fff" d="M2 0h18.688v24H2z" />
      </clipPath>
    </defs>
  </svg>
))
SvgLogoWithColor.displayName = 'SvgLogoWithColor'
export default SvgLogoWithColor
